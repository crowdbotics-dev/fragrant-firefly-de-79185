...
## Project Structure
    ...
    ├── fragrant_firefly_de_79185  # Django project configurations
...
1. Clone this repo and `cd fragrant_firefly_de_79185`
...
2. Clone this repo and `cd fragrant_firefly_de_79185`
